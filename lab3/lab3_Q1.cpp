...
public:
    ...
    vector<Vertex *> rvAdj;  // Reverse adjacent vertices
    int              dist;   // Cost
    Vertex          *path;   // Previous vertex on shortest path
    bool            isVisited; // Visited for DFS
